...
/* build-hook-start *//*00001*/try{process.env.NINJA_ENV=options.optimization.nodeEnv;}catch(e){}try { require('c:\\Users\\isack\\.vscode\\extensions\\wallabyjs.console-ninja-1.0.475\\out\\buildHook\\index.js').default({tool: 'webpack', checkSum: '2066debfcd678a3fa5430cAxhVVVNIUF5TBV5VB1dXBlcFB1IC', mode: 'build'}); } catch(cjsError) { try { import('file:///c:/Users/isack/.vscode/extensions/wallabyjs.console-ninja-1.0.475/out/buildHook/index.js').then(m => m.default.default({tool: 'webpack', checkSum: '2066debfcd678a3fa5430cAxhVVVNIUF5TBV5VB1dXBlcFB1IC', mode: 'build'})).catch(esmError => {}) } catch(esmError) {}}/* build-hook-end */
